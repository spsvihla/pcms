...
// double precision sparse matrix-matrix multiply
// C <- A^T * B
inline SparseMatrix<double>
dspmtm(SparseMatrix<double>& A, SparseMatrix<double>& B, int n, int m, int nnz_max)
{
...
sparsify(Tree* tree)
{
    ...
    S = dspmtm(Q, S, n_nodes, n_nodes, 1);
